                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="login.php"><i class="fas fa-building fa-fw me-2"></i>Headquarters</a></li>
                            <li><a class="dropdown-item" href="login.html?role=zonal"><i class="fas fa-map fa-fw me-2"></i>Zonal</a></li>
                            <li><a class="dropdown-item" href="login.html?role=state"><i class="fas fa-flag fa-fw me-2"></i>State</a></li>
                        </ul>
                    </li>
                </ul>
