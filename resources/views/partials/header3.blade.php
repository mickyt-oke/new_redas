        ...
        <div class="topbar-right">
            ...
            <div style="position:relative;">
                <button class="topbar-user" id="userMenuBtn" onclick="const d=document.getElementById('userMenuDrop');if(d){const show=d.style.display==='none'||!d.style.display;d.style.display=show?'block':'none';d.classList.toggle('open',show);}event.stopPropagation();" style="border:none;background:transparent;cursor:pointer;">
                    <div class="topbar-avatar" style="background:var(--color-info); padding:0; overflow:hidden; display:flex; align-items:center; justify-content:center;">
                ...
                <div id="userMenuDrop" onclick="event.stopPropagation()" style="display:none;position:absolute;right:0;top:calc(100% + 8px);width:210px;background:white;border-radius:var(--radius-md);box-shadow:var(--shadow-lg);border:1px solid var(--gray-200);z-index:9999;overflow:hidden;">
