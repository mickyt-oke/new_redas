@include('partials.header')
        ...
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">
                    Welcome, <strong>{{ auth()->user()->name ?? 'Officer' }}</strong> &bull;
                    {{ now()->format('l, d F Y') }}
                </p>
            </div>
        </div>
    ...
    @foreach($directorates as $dir)
        ...
        <a href="{{ $dir['slug'] === 'visa'
                ? route('visa.dashboard')
                : ($dir['slug'] === 'ict' ? route('ict.dashboard') : route('user.directorates.show', $dir['slug'])) }}"
           ...
           onmouseout="this.style.borderColor='var(--gray-200)';this.style.transform='translateY(0)';this.style.boxShadow='none'">
            ...
            <span style="flex:1;">
                <strong style="font-size:.875rem;display:block;margin-bottom:3px;">
                    {{ $dir['name'] }}
                </strong>
            ...
            <i class="fas fa-arrow-right"
               style="font-size:.75rem;color:var(--gray-400);margin-top:4px;flex-shrink:0;"></i>
