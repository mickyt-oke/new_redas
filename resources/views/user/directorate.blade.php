            ...
            <div class="card-body">
                @php
                    $directorates = [
                        ...
                        ['slug' => 'isct',          'name' => 'Standards and Compliance Unit (ISCT)', 'icon' => 'fas fa-clipboard-check', 'desc' => 'Standards compliance, staff strength, cases and enforcement actions.'],
                        ['slug' => 'internal-audit', 'name' => 'Internal Audit', 'icon' => 'fas fa-file-invoice', 'desc' => 'Quarterly audit inspection reports, funds utilisation, revenue and stock verification.'],
                    ];
                @endphp
