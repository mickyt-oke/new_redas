...
class DashboardController extends Controller
{
	public function showDirectorate(string $slug): View
	{
		...
		// Use the detailed investigation-specific view for the investigation slug
		if ($slug === 'investigation') {
			return view('user.directorate-investigation', [
				'slug' => $slug,
		...
		// Use the custom ISCT view for the Standards and Compliance Unit
		if ($slug === 'isct') {
			return view('user.directorate-isct', [
				'slug' => $slug,
				'directorate' => $directorates[$slug],
				'allDirectorates' => $directorates,
			]);
		...
		// Use the custom Internal Audit view
		if ($slug === 'internal-audit') {
			return view('user.directorate-internal-audit', [
				'slug' => $slug,
				'directorate' => $directorates[$slug],
				'allDirectorates' => $directorates,
			]);
